...
import Carousel from "../../assets/img/hero-carousel/inaraintro1.1.webp"
        ...
        >
          ...
          >
            ...
            <div className="carousel-inner w-full">
              {/* Slide 1 */}
              <div className="carousel-item active w-full relative">
                {/* <div className="absolute inset-0 flex items-end justify-center py-8">
                  <a
                    href={inaraintrovideo}
                    className="glightbox"
                    data-video="youtube"
                  >
                    <RxVideo className="text-white text-4xl cursor-pointer" />
                  </a>
                </div> */}
                <img src={Carousel} className="w-full" alt="Slide 1" />
              </div>
              {/* Slide 2 */}
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8 sm:pb-32">
              <div className="sm:max-w-lg z-50 relative">
                <h1 className="text-xl font-bold tracking-tight text-gray-900 sm:text-4xl pt-5 font-times">
                  Over 15 Years of Experience in the Textile Industry
                </h1>
              ...
              <div>
                <div>
                  ...
                  {/* <div className="px-4 py-3 text-center font-medium text-gray-600 z-50 relative">
                  <a
                    href={inaraintrovideo}
                    className="glightbox"
                    data-video="youtube"
                  >
                    <RxVideo className=" text-4xl cursor-pointer" />
                  </a>
                </div> */}
                  </div>
